...
import { ProjectileSystem, ArcherAttackParams, RangeCalculationResult } from './projectile.system';
...
export class RealtimeCombatController {
  ...
  async getArcherRangeInfo(
    ...
    return {
      ...
      bonuses: {
        ...
        classBonus: character.characterClass === CharacterClass.ARCHER ? '30%' : '0%'
      }
    };
  }
  ...
  async testArcherRange(@Body() testData: {
    ...
    const rangeResult = this.projectileSystem.calculateArcherRange(archerParams);
