...
@Module({
  ...
  providers: [NpcsService, ShopService, ProfessionService, DialogueService, EnhancedDialogueService],
  exports: [NpcsService, ShopService, ProfessionService, DialogueService, EnhancedDialogueService],
})
